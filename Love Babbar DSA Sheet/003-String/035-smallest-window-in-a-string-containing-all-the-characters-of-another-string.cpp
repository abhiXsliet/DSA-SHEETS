...
class Solution
{
    ...
    // TC : O(M)
    // SC : O(N)
    string solve_optimal_1(string& s, string& p) {
        int m = s.length();
        int n = p.length();
    ...
    // TC : O(M)
    // SC : O(N)
    string solve_optimal_2(string& s, string& p) {
        int m = s.length();
        int n = p.length();
    ...
    // TC : O(M)
    // SC : O(1)
    string solve_optimal_3(string& s, string& p) {
        int m = s.length();
        int n = p.length();
    ...
    string smallestWindow (string s, string p) {
        // return solve_optimal_1(s, p);
        
        // return solve_optimal_2(s, p);
        
        return solve_optimal_3(s, p);
    }
};
